          ...
          <Card className="lg:col-span-2">
            <CardHeader>
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  ...
                  <CardDescription>
                    Select an available slot (green) to book or an occupied slot (red/orange) for details.
                  </CardDescription>
                </div>
            ...
            <CardContent>
              ...
              <div className="mt-6 flex flex-wrap gap-6 items-center text-sm font-medium border-t pt-4">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-4 h-4 rounded-sm" style={{ backgroundColor: SLOT_COLOR_OVERTIME }}></div>
                  <span>Overtime</span>
                </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-primary/5 border-primary/20">
              ...
              <CardContent className="text-sm text-zinc-600 dark:text-zinc-400">
                Click on any <span className="text-emerald-600 font-bold">Green</span> slot to book. <span className="text-red-600 font-bold">Red</span> means booked, and <span className="text-orange-500 font-bold">Orange</span> means the session has exceeded its duration.
              </CardContent>
            </Card>
          </div>
        </div>
