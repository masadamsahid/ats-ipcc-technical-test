# ATS-IPCC Assignment Projects

This repository contains two unrelated projects developed as part of an assignment. Each project is located in its own directory and includes its own detailed instructions and documentation.
...
- **Instructions:** Refer to [kraprac-frontend/README.md](./kraprac-frontend/README.md) for installation and development server setup.

---

## Getting Started

Each project is self-contained. To get started with either, navigate into its directory and follow the project-specific documentation:

- **Backend:** `cd tsilodot-backend-go`
- **Frontend:** `cd kraprac-frontend`
